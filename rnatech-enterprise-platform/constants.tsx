...
export const ICONS = {
  ...
  TwitterX: ({ className }: { className?: string }) => (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={`w-5 h-5 ${className || ''}`}>
...
export const TRANSLATIONS: Record<string, { bn: string; en: string }> = {
  ...
  shop_categories_title: { bn: 'ক্যাটাগরি', en: 'Categories' },
  cat_all: { bn: 'সব পণ্য', en: 'All Products' },
  cat_iot: { bn: 'আইওটি সিস্টেম', en: 'IoT Systems' },
  cat_smart_home: { bn: 'স্মার্ট হোম', en: 'Smart Home' },
  cat_robotics: { bn: 'রোবটিক্স', en: 'Robotics' },
  cat_sensors: { bn: 'সেন্সর', en: 'Sensors' },
  cat_power: { bn: 'পাওয়ার', en: 'Power' },
  checkout_shipping_district: { bn: 'জেলা নির্বাচন করুন', en: 'Select District' },
  checkout_dhaka: { bn: 'ঢাকা সিটি', en: 'Dhaka City' },
  checkout_outside_dhaka: { bn: 'ঢাকার বাইরে', en: 'Outside Dhaka' },
  checkout_step_info: { bn: 'তথ্যাদি', en: 'Information' },
  checkout_step_shipping: { bn: 'শিপিং', en: 'Shipping' },
  checkout_step_payment: { bn: 'পেমেন্ট', en: 'Payment' },
  checkout_promo_code: { bn: 'প্রমো কোড', en: 'Promo Code' },
  checkout_apply: { bn: 'প্রয়োগ করুন', en: 'Apply' },
  ...
  // Auth Pages
  auth_login_title: { bn: 'কাস্টমার লগইন', en: 'Customer Portal' },
  auth_login_subtitle: { bn: 'আপনার কাস্টমার অ্যাকাউন্টে প্রবেশ করতে তথ্য দিন', en: 'Login to your customer account to manage orders' },
  auth_signup_title: { bn: 'কাস্টমার রেজিস্ট্রেশন', en: 'Customer Registration' },
  auth_signup_subtitle: { bn: 'আরএনএটেক মেম্বার হিসেবে যুক্ত হতে তথ্য দিন', en: 'Join RNAtech as a valued customer today' },
  ...
  auth_btn_login: { bn: 'লগইন করুন', en: 'Login Now' },
  auth_btn_signup: { bn: 'নিবন্ধন করুন', en: 'Create Account' },
  auth_role_customer: { bn: 'কাস্টমার লগইন', en: 'Customer' },
  auth_role_admin: { bn: 'অ্যাডমিন এক্সেস', en: 'Admin' },
  // Checkout Page
  ...
  // Tracking & Sorting
  shop_sort_price_low: { bn: 'মূল্য: কম থেকে বেশি', en: 'Price: Low to High' },
  shop_sort_price_high: { bn: 'মূল্য: বেশি থেকে কম', en: 'Price: High to Low' },
  shop_sort_name: { bn: 'নাম অনুযায়ী', en: 'Sort by Name' },
  shop_search_placeholder: { bn: 'পণ্য খুঁজুন...', en: 'Search products...' },
  tracking_title: { bn: 'অর্ডার ট্র্যাকিং', en: 'Order Tracking' },
  tracking_desc: { bn: 'আপনার অর্ডারের বর্তমান অবস্থা জানতে অর্ডার আইডি দিন।', en: 'Enter your Order ID to see the current status of your delivery.' },
  tracking_placeholder: { bn: 'অর্ডার আইডি (যেমন: ORD-123456)', en: 'Order ID (e.g., ORD-123456)' },
  tracking_btn: { bn: 'ট্র্যাক করুন', en: 'Track Order' },
  tracking_status_pending: { bn: 'পেন্ডিং', en: 'Pending' },
  tracking_status_processing: { bn: 'প্রসেসিং', en: 'Processing' },
  tracking_status_shipped: { bn: 'শিপড', en: 'Shipped' },
  tracking_status_delivered: { bn: 'ডেলিভার্ড', en: 'Delivered' },
  tracking_eta: { bn: 'সম্ভাব্য ডেলিভারি', en: 'Estimated Delivery' },
  // Payment
  payment_bkash: { bn: 'বিকাশ', en: 'bKash' },
  payment_nagad: { bn: 'নগদ', en: 'Nagad' },
  payment_rocket: { bn: 'রকেট', en: 'Rocket' },
  payment_card: { bn: 'কার্ড পেমেন্ট', en: 'Card Payment' },
  payment_digital: { bn: 'ডিজিটাল ব্যাংকিং (SSL Commerz)', en: 'Digital Banking (SSL Commerz)' },
  payment_cod: { bn: 'ক্যাশ অন ডেলিভারি', en: 'Cash on Delivery' },
  portfolio_title: { bn: 'সফল প্রোজেক্টসমূহ', en: 'Successful Projects' },
  portfolio_desc: { bn: 'আমাদের ক্লায়েন্টদের সফলতার গল্প', en: 'Our Success Stories' },
  portfolio_client: { bn: 'ক্লায়েন্ট', en: 'Client' },
  portfolio_completed: { bn: 'সম্পন্ন', en: 'Completed' },
  portfolio_tech_stack: { bn: 'ব্যবহৃত প্রযুক্তি', en: 'Tech Stack' },
  portfolio_view_details: { bn: 'বিস্তারিত দেখুন', en: 'View Details' },
  portfolio_close: { bn: 'বন্ধ করুন', en: 'Close' },
};
